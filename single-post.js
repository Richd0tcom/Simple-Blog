...
function renderComments(args) { 
    ...
    commentSection.innerHTML = args.map((comment,i)=>{
        return `
        <div class="px-5 pt-5 pb-5 mt-6 md:mt-7 md:pb-12 md:pt-12 test rounded-lg shadow-lg">
        ...
        <div class="flex pt-3 md:px-5 md:pt-5 pb-5">
          <div class=" self-center pt-1 "><img class="w-6 h-6 rounded-[50%] md:w-8 md:h-8" src="./Images/profile-2.jpg"
              alt="commenter"></div>
          <div class="md:ml-3">
